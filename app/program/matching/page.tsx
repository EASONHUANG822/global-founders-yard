...
export const metadata = {
  title: "Matching | Global Founders Yard",
  description:
    ...
    <main className="min-h-screen bg-yard-black px-5 py-8 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <section className="py-20 lg:py-28">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-white/[0.42]">Landing Engine &mdash; Matching</p>
          <h1 className="mt-6 max-w-5xl text-balance text-6xl font-black leading-[0.88] tracking-[-0.075em] sm:text-7xl lg:text-8xl">The right match changes everything.</h1>
          <p className="mt-8 max-w-3xl text-lg leading-8 text-white/[0.62]">
            Once we understand your needs, we map the Shenzhen ecosystem to find the right suppliers, manufacturers, component sources, and technical partners. Not a generic list — targeted introductions based on your specific product, volume, and timeline.
          </p>
        </section>

        <section className="grid gap-4 md:grid-cols-3">
          {[
            { title: "Supplier mapping", description: "Identify component suppliers, material sources, and specialized parts vendors that match your technical requirements and volume needs." },
            { title: "Manufacturer matching", description: "Connect with contract manufacturers experienced in your product category, from PCB assembly to full system integration." },
            { title: "Technical partners", description: "Find iteration partners, testing labs, and engineering services that can accelerate your hardware development cycle." },
          ].map((card) => (
