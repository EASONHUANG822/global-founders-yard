      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="py-20 lg:py-28">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-white/[0.42]">
            Ecosystem &mdash; Software and Autonomy
          </p>
          <h1 className="mt-6 max-w-5xl text-balance text-6xl font-black leading-[0.88] tracking-[-0.075em] sm:text-7xl lg:text-8xl">
            The intelligence layer that makes robots useful.
          </h1>
          <p className="mt-8 max-w-3xl text-lg leading-8 text-white/[0.62]">
            Hardware without software is a prototype. ROBOTUO connects founders
            with the perception, control, and edge AI infrastructure needed to
            build autonomous systems that work in the real world. From sensor
            fusion to deployment pipelines, the platform bridges the gap between
            physical robotics and intelligent operation.
          </p>
        </section>
          ...
          {[
            {
              ...
              description:
                "Access expertise in computer vision, SLAM, sensor fusion, and motion control systems that form the core of autonomous robotics.",
            },
            {
              title: "Edge AI infrastructure",
              description:
                "Deploy models on-device with the right compute, runtime, and optimization stack for real-time robotics applications.",
            },
            {
              title: "Data and deployment loops",
              description:
                "Build continuous improvement pipelines from field data to model updates, enabling robots to get better with every deployment.",
            },
          ].map((card) => (
            <article
              key={card.title}
