      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="py-20 lg:py-28">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-white/[0.42]">
            Support &mdash; Supplier Introductions
          </p>
          <h1 className="mt-6 max-w-5xl text-balance text-6xl font-black leading-[0.88] tracking-[-0.075em] sm:text-7xl lg:text-8xl">
            Skip months of supplier discovery.
          </h1>
          <p className="mt-8 max-w-3xl text-lg leading-8 text-white/[0.62]">
            Finding the right suppliers in Shenzhen takes time and local
            knowledge. ROBOTUO provides curated introductions to vetted
            suppliers, manufacturers, and component sources — connecting you
            directly with production partners who match your technical
          ...
          {[
            {
              ...
              description:
                "Introductions to suppliers for sensors, motors, controllers, custom mechanical parts, and specialized robotics components.",
            },
            {
              title: "Manufacturing partners",
              description:
                "Connect with contract manufacturers for PCB assembly, enclosure fabrication, system integration, and quality testing.",
            },
            {
              title: "Production scaling",
              description:
                "Find partners experienced in transitioning from prototype to low-volume production and eventually to scaled manufacturing.",
            },
          ].map((card) => (
            <article
              key={card.title}
